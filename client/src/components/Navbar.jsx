...
export default function Footer() {
    return <CustomNav >
        ...
        <CustomNavLink to="/measure" className={({isActive}) => isActive ? 'active' : null}><NavContent><box-icon color='white' type='solid' name='ruler'></box-icon>Measure</NavContent></CustomNavLink> 
    </CustomNav>
}